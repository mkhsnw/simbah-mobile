...
import 'package:simbah/pages/admin/admin_detail_monthly.dart';
...
final GoRouter router = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: '/admin/withdraw-requests', builder: (context, state) => AdminWithdrawRequestsPage()),
    GoRoute(path: '/admin/dashboard', builder: (context, state) => AdminDashboardPage()),
    GoRoute(path: '/admin/reports', builder: (context, state) => AdminLaporanPage()),
    GoRoute(path: '/admin/waste-types', builder: (context, state) => AdminWasteTypePage()),
    GoRoute(path: '/admin/users', builder: (context, state) => AdminUserPage()),
    GoRoute(path: '/admin/transactions', builder: (context, state) => AdminTransaksiPage()),
    GoRoute(
      path: '/admin/detail-montly-transaction',
      builder: (context, state) => AdminDetailMonthly(qp: state.extra as Map<String, String>),
    ),
  ],
  ...
  errorBuilder: (context, state) => Scaffold(body: Center(child: Text('Halaman tidak ditemukan: ${state.error}'))),
);
